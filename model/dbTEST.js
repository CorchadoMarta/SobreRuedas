[{
	idTema: 1,
	pregunta: "Un camión de 3.500 kg de MMA, ¿puede circular por una vía de automóviles?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "En una calzada de un sentido en la que no existen marcas viales, ¿cuántos carriles pueden existir a efectos de su utilización?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "¿Qué vehículos pueden circular por el arcén en paralelo?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "En esta calzada, ¿qué vehículos pueden circular por el arcén?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "Circula correctamente este vehículo especial de 3.500 kg de masa máxima autorizada?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "¿Puede un ciclomotor adelantar al tractor agrícola?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "Cuando debido a una vería circule por una autopista a velocidad anormalmente reducida, ¿por dónde lo hará?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "¿Qué elementos ha de llevar obligatoriamente un turismo?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "Si se encuentra detenido en un semáforo en rojo, ¿puede utilizar el teléfono móvil?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "¿Circula correctamente este vehículo?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "Al cruzarse con el camión, ¿qué separación lateral debe mantener?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "En una vía interurbana con tres carriles para el mismo sentido, ¿por cuál debe circular, con carácter general?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "En una vía urbana con varios carriles para cda sentido delimitados por marcas viales, ¿qué carril debe utilizar?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "Este conjunto de vehículos mide 8 metros, ¿por que carril tiene permitido circular?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "¿Pueden los ciclistas circular por el arcén en autopista?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "¿Qué indican estas luces de semáforo en una autopista de peaje?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "Si por razones de emergencia circula por una autopista a una velocidad anormalmente reducida, ¿qué debe hacer?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "En un carril en sentido contrario al habitual instalado para mejorar la fluidez del tráfico, ¿qué vehículos pueden circular?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "De día, ¿en qué circunstancia debe llevar encendida la luz de corto alcance?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "¿A cuál de estos vehículos no se le permite circular por un carril de sentido contrario al habitual, como norma general?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "¿Qué normas se deben cumplir si se circula por el carril central de esta calzada?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "Los vehículos que circulen por un carril adicional circunstancial deben hacerlo...",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "Si se circula a mayor velocidad de la indicada en la señal, ¿se está obligado a circular por el carril de la derecha, si las circunstancias lo permiten?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "En este tramo de carril BUS, ¿cuál de las siguientes maniobras está permitida?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "¿Deberemos facilitar la incorporación a los vehículos que se aproximen por un carril de aceleración?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "Circula por una autovía y se dispone a salir utilizando un carril de deceleración, ¿cuándo debe entrar en dicho carril?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "Conduce su turismo con un remolque ligero, ¿puede utilizar el carril VAO?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "¿Puede un turismo con esta señal circular por un carril VAO?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "En motocicleta, ¿está permitido circular por el carril VAO?",
	respuestas:{
...
{
	idTema: 1,
	pregunta: "Un vehículo prioritario, ¿puede utilizar un carril VAO?",
	respuestas:{
